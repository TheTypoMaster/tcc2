...
\begin{tikzpicture}[node distance = 2cm, auto]
	...
	\node [block, left of=identify, node distance=9cm] (update) {$k++$\\$T_k = q \times T_{k-1}$};
    \node [block, below of=decide, node distance=9cm] (stop) {Segmentos de comprimento $l$ centrados nos candidatos identificados \\ FIM};
    % Draw edges
